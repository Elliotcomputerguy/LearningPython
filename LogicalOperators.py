...
# ===============================================================
# The following evaluated compund condition evaluates to False because the first simple conditonal evaluates to False. 
# A 100 is not less than 5. But 11 is less than 50 which is True. The and logical operator uses the below rules when evalauting
# simple conditions.
# ===============================================================
...
# When using not there is a order of operator precedence. When you attempt to evaluate False == not True you will receive an error 
